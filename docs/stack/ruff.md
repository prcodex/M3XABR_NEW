...
**Package:** `ruff`  •  **Version pin:** `>=0.5`  •  **Extras group:** `m3xabr-core[dev]`  •  **Role:** Linter + formatter
...
- `CONTRIBUTING.md` — `ruff check m3xabr_core/ tests/` listed as part of the pre-commit checklist.
