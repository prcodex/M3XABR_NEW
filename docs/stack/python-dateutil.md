...
- `m3xabr_core/actors/retriever.py` — when sorting/filtering retrieved docs by recency.
- `m3xabr_core/actors/synthesizer.py` — when formatting timestamps for the system prompt.
