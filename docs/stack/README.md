...
- **what the tool does** in the context of m3xabr-core
...
- `m3xabr_core/backends/<file>.py` — primary integration
- `<other usages, if any>`
...
## How to swap it out
Concrete steps if someone forks and wants to replace it. Usually: implement the corresponding interface in `m3xabr_core/backends/`.
